...
def upload_video():
    ...
    try:
        ...
        # ------------------------------------------
            ...
            print(
                "Video chunk does not exist yet."
            )
